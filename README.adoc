...
* https://cratedb.com/[CrateDB] - A hyper-fast open source database for time series, documents and vectors, combining the simplicity of SQL with the scalability of a distributed architecture.
